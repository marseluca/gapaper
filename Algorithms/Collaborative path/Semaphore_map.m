...
mapp = import_data_catia_vrml('semaphore.wrl');
figure;

for i=1:size(mapp.points,2)
    if mapp.points(3,i)==0.02
...
for i=1:size(mapp.lines,2)
    if mapp.points(3,mapp.lines(1,i))==0.02 && mapp.points(3,mapp.lines(2,i))==0.02

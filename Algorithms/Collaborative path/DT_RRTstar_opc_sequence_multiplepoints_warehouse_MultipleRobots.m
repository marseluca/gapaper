...
mapp = import_data_catia_vrml('MAPPA.wrl');
figure;
...
map.lines = [map.lines; addedLines];
...
%% Triangulation
tic;
triangulation = delaunayTriangulation(map.points,addedLines);
...
% 
% for i=1:size(triangulation.Points,1)
%     text(map.points(i,1),map.points(i,2),num2str(i),'Color','black');
% end
...
couples = [-400, 8; -200, 300; -600, 300; 200, 300; -600, 950; -200, 700; -600, 100];

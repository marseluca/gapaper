...
% load('Workspaces/paths_dtrrt_3_one_couple_gaussian.mat');
load('Workspaces/paths_dtrrt_3_one_couple_2_gaussian.mat');
...
% xlabel('Map2,first fixed couple,30 points Gaussian distr.,200 paths');
xlabel('Map2,second fixed couple,30 points Gaussian distr.,200 paths');
ylabel('Length [m]');

ylim([866.015, 3736.81]);
